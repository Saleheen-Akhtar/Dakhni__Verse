...
export interface Session { id: string; artist_id: string | null; project_id: string | null; session_type: SessionType; engineer_id: string | null; session_date: string; start_time: string; end_time: string; duration_minutes: number | null; notes: string | null; status?: SessionStatus; cancellation_reason?: string | null; cancelled_at?: string | null; cancelled_by?: string | null; created_by: string | null; created_at: string; updated_at: string; }
